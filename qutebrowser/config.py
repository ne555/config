...
config.bind(';d', 'hint all spawn download_media.sh {hint-url}')
config.bind(';D', 'spawn download_media.sh {url}')
...
c.url.searchengines = {
        ...
        'anime' : 'https://myanimelist.net/search/all?q={}',
        ...
        'wr' : 'http://www.wordreference.com/es/translation.asp?tranword={}',
