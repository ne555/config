...
bind_multiple(['H', '<backspace>', ',', '<'], 'back')
bind_multiple(['L', '.', '>'], 'forward')
...
bind_multiple(['<return>', '<ctrl-m>', '<ctrl-j>', '<shift-return>', '<enter>', '<shift-enter>'], 'follow-selected')
bind_multiple(['<ctrl-return>', '<ctrl-enter>'], 'follow-selected -t')
...
c.aliases['je'] = 'set content.javascript.enabled True'
c.aliases['jd'] = 'set content.javascript.enabled False'
...
## menu. For QtWebEngine, see `--enable-webkit-inspector` in `qutebrowser
## --help` instead.
## Type: Bool
